...
<body>
    ...
    <div class="container  ">
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <p>
          A vaccination system manages vaccine scheduling, patient records, and inventory to ensure efficient immunization program operations. It tracks doses, sends reminders, and generates reports for monitoring coverage and effectiveness, promoting public health through streamlined management and data-driven decision-making.   
          </p>
            <a href="">
              Read More
            </a>
  ...
  <section class="doctor_section layout_padding" id="hospital">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          Our Hospitals
              ...
              <div class="form-row">
                <div class="col-lg-6">
                  <div>
                    ...
                    <input type="text" placeholder="Your Name" value="<?php echo $active_patient['name'];?>"  />
                  </div>
                </div>
                <div class="col-lg-6">
                  <div>
                    <input type="text" placeholder="Phone Number" value="<?php echo $active_patient['contact'];?>" />
                  </div>
                </div>
              </div>
              <div>
                <input type="email" placeholder="Email" value="<?php echo $active_patient['email'];?>" />
              </div>
              <div>
